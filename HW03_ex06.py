...
###############################################################################
# Exercise 6.2
# See 6.1: "write a compare function that takes two values, x and y, and returns 1
...
def is_palindrome(s):
    ...
    if n > 2:
        if s[0] == s[-1]:
            s = s[1:-1]  # cutting first and last letter of the string
            # repeating function until only one or two letters to compare left
